...
class BaseScyllaCluster(object):
    ...
    def update_db_binary(self, node_list=None):
        ...
        if new_scylla_bin and os.path.exist(new_scylla_bin) and \
                os.listdir(new_scylla_bin):
    ...
    def update_db_packages(self, node_list=None):
        ...
        if new_scylla_packages and os.path.exist(new_scylla_packages) and \
                os.listdir(new_scylla_packages):
            if node_list is None:
                node_list = self.nodes
